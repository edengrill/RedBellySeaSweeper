...
void SwoopDeviceAudioProcessorEditor::resized()
{
    ...
    // Position combo boxes - moved left and adjusted spacing
    waveTypeLabel.setBounds(320, 405, 50, 30);
    waveTypeCombo.setBounds(375, 405, 110, 30);
    
    sweepModeLabel.setBounds(500, 405, 50, 30);
    sweepModeCombo.setBounds(555, 405, 95, 30);
}
