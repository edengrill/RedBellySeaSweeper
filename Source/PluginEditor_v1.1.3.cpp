    ...
    : AudioProcessorEditor (&p), audioProcessor (p)
{
    ...
    // Setup combo boxes - NOTE: Using regular ComboBox, not DropUpComboBox
...
void SwoopDeviceAudioProcessorEditor::resized()
{
    ...
    // Position branding text at bottom
    pluginNameLabel.setBounds(50, 400, 300, 25);
    authorLabel.setBounds(50, 425, 200, 22);
    
    // Position combo boxes at TOP (between waveform and control panel)
    // This gives them space to drop DOWN without overlapping
    waveTypeLabel.setBounds(200, 205, 50, 25);
    waveTypeCombo.setBounds(255, 205, 110, 25);
    
    sweepModeLabel.setBounds(380, 205, 50, 25);
    sweepModeCombo.setBounds(435, 205, 100, 25);
}
