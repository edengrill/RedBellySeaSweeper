...
void SwoopDeviceAudioProcessorEditor::resized()
{
    ...
    // Position branding text - moved left to align better
    pluginNameLabel.setBounds(50, 390, 300, 25);
    authorLabel.setBounds(50, 412, 200, 22);
    
    // Position combo boxes near bottom edge (moved down from 405 to 430)
    waveTypeLabel.setBounds(360, 430, 50, 25);
    waveTypeCombo.setBounds(415, 430, 110, 25);
    
    sweepModeLabel.setBounds(540, 430, 50, 25);
    sweepModeCombo.setBounds(595, 430, 85, 25);
}
